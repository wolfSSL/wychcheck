# wolfcrypt-check: Wycheproof test vectors for wolfSSL
...
## What wolfcrypt-check does

This wolfcrypt-check repo links against a built wolfSSL and runs every applicable Wycheproof
...
git clone --recurse-submodules https://github.com/wolfSSL/wolfcrypt-check.git
cd wolfcrypt-check
...
The point of this wolfcrypt-check repo is that you run it against **your** wolfSSL build,
